...
export const REST_API = {
    ...
    HOST_BALANCERS: {
        GET: (hostUuid: string) =>
            `${ROOT}/${CONTROLLERS.HOST_BALANCERS_CONTROLLER}/${CONTROLLERS.HOST_BALANCERS_ROUTES.GET(
                hostUuid,
            )}`,
        UPDATE: (hostUuid: string) =>
            `${ROOT}/${CONTROLLERS.HOST_BALANCERS_CONTROLLER}/${CONTROLLERS.HOST_BALANCERS_ROUTES.UPDATE(
                hostUuid,
            )}`,
        TOGGLE: (hostUuid: string) =>
            `${ROOT}/${CONTROLLERS.HOST_BALANCERS_CONTROLLER}/${CONTROLLERS.HOST_BALANCERS_ROUTES.TOGGLE(
                hostUuid,
            )}`,
        TARGETS: (hostUuid: string) =>
